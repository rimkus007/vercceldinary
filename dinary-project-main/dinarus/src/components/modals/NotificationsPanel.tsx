...
export default function NotificationsPanel({
  ...
  // --- Fonctions de style et de formatage (inchangées, votre style original) ---
  ...
  // Use hook to get deleteAllNotifications
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center">
                                ...
                                {!notification.isRead && (
                                  <div className="ml-1 w-2.5 h-2.5 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 flex-shrink-0 mt-1 shadow-sm"></div>
                                )}
                              </div>
                            </motion.div>
                          );
